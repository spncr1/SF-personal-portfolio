...
<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 640 320" role="img" aria-label="Sydney location map standby">
  <defs>
    <pattern id="grid" width="24" height="24" patternUnits="userSpaceOnUse">
      <path d="M 24 0 L 0 0 0 24" fill="none" stroke="#2e3b52" stroke-opacity=".18" stroke-width="1"/>
    </pattern>
  </defs>
  <rect width="640" height="320" fill="#141416"/>
  ...
  <path d="M64 176c45-18 85-18 118-4 38 16 58 45 102 41 39-4 62-31 98-31 44 0 65 42 109 42 31 0 55-18 86-25" fill="none" stroke="#f0c888" stroke-opacity=".25" stroke-width="2"/>
  ...
  <text x="34" y="44" fill="#e08a46" font-family="monospace" font-size="18" letter-spacing="4">MAP API STANDBY</text>
</svg>`;
}
